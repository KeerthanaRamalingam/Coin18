...
1. Clone the Eurekacoin Core source code:
        ...
        git clone --recursive https://github.com/eurekacoinproject/eurekacoin.git
        cd eurekacoin
...
The first time you run eurekacoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
