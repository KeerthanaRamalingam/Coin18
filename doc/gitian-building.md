...
git clone https://github.com/eurekacoinproject/eurekacoin --recursive
git clone https://github.com/eurekacoinproject/gitian.sigs.git
```
...
Output from `gbuild` will look something like
    ...
    From https://github.com/eurekacoinproject/eurekacoin
...
cd /some/root/path/
git clone https://github.com/eurekacoinproject/eurekacoin-detached-sigs.git
...
[eurekacoinproject/gitian.sigs](https://github.com/eurekacoinproject/gitian.sigs/) repository, or if that's not possible create a pull
