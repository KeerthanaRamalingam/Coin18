...
consensus.defaultAssumeValid = uint256S("0x2c05cec4ac23725cdc2126f107d5eff79f37d18094072b31054f0c1e84de63dd"); // 1383700
        ...
        genesis = CreateGenesisBlock(1561381942, 361734, 0x1f00ffff, 1, 1 * COIN);        consensus.hashGenesisBlock = genesis.GetHash();
        if (startNewChain)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0xcac08663e56c596bc72e2d659a420d38b0924ef5b60cf35c5197ffe3766ed01c"); // 320000
