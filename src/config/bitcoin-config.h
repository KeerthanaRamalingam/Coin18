...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Eurekacoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Eurekacoin Core"
...
/* Define to 1 to enable bitcore rpc functions */
/* #undef ENABLE_BITCORE_RPC */
...
#define PACKAGE_BUGREPORT "https://github.com/eurekacoinproject/eurekacoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Eurekacoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Eurekacoin Core 0.18.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "eurekacoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://eurekacoin.org/"
